...
구글 시트에서 수기로 관리하던 사용자 포인트 정보를 이용하여 신청곡 신청 및 포인트 차감, 지급 등을 자동화합니다.

개발하면서 고민한 부분을 Issue에 서술하고 있습니다.
...
▼ infrastructure
  ...
  ▼ presentation
    ▼ http
      HTTP API를 서빙하는 코드를 담고 있습니다.
      ▼ songs
        - songs.controller.ts
      ...
    ▼ tmi
      트위치 채팅을 서빙하는 코드를 담고 있습니다.
      ▼ songs
        - songs.controller.ts
      ...
    ▼ ...
